namespace System
{
    ...
    public static class DateTimeExtension
    {
        ...
        /// <param name = "dateOfBirth">The date & time of birth.</param>
        /// <returns>The calculated age.</returns>
        public static int CalculateAge(this DateTime dateOfBirth) { return CalculateAge(dateOfBirth, Clock.Now.Date); }
        ...
        public static DateTime GetFirstDayOfMonth(this DateTime datetime) { return new DateTime(datetime.Year, datetime.Month, 1); }
        ...
        public static DateTime GetLastDayOfMonth(this DateTime datetime) { return new DateTime(datetime.Year, datetime.Month, GetCountDaysOfMonth(datetime)); }
        ...
        /// </returns>
        public static bool IsToday(this DateTime datetime) { return (datetime.Date == DateTime.Today); }
        ...
        /// </returns>
        public static DateTime SetTime(this DateTime datetime, TimeSpan timeSpan) { return datetime.Date.Add(timeSpan); }
        ...
        public static DateTime SetTime(this DateTime datetime, int hours, int minutes, int seconds, int milliseconds) { return datetime.SetTime(new TimeSpan(0, hours, minutes, seconds, milliseconds)); }
        ...
        /// <returns>The DateTime including the new time value</returns>
        public static DateTime SetTime(this DateTime datetime, int hours, int minutes, int seconds) { return datetime.SetTime(hours, minutes, seconds, 0); }
        ...
        /// <param name = "localDateTime">The local DateTime.</param>
        /// <returns>The converted DateTimeOffset</returns>
        public static DateTimeOffset ToDateTimeOffset(this DateTime localDateTime) { return localDateTime.ToDateTimeOffset(default(TimeZoneInfo)); }
        ...
        /// </remarks>
        public static DateTime GetFirstDayOfWeek(this DateTime datetime) { return datetime.GetFirstDayOfWeek(ExtensionMethodSetting.DefaultCulture); }
        ...
        /// <param name = "cultureInfo">The culture to determine the first weekday of a week.</param>
        /// <returns>The first day of the week</returns>
        public static DateTime GetLastDayOfWeek(this DateTime datetime, CultureInfo cultureInfo) { return datetime.GetFirstDayOfWeek(cultureInfo).AddDays(6); }
        ...
        ///     modified by jtolar to implement culture settings
        /// </remarks>
        public static DateTime GetLastDayOfWeek(this DateTime datetime) { return datetime.GetLastDayOfWeek(ExtensionMethodSetting.DefaultCulture); }
        ...
        ///     modified by jtolar to implement culture settings
        /// </remarks>
        public static DateTime GetWeeksWeekday(this DateTime datetime, DayOfWeek weekday) { return datetime.GetWeeksWeekday(weekday, ExtensionMethodSetting.DefaultCulture); }
        ...
        /// </returns>
        public static bool IsDateEqual(this DateTime datetime, DateTime dateToCompare) { return (datetime.Date == dateToCompare.Date); }
        ...
        public static long ToUnixEpoch(this DateTime dateTime) { return GetMillisecondsSince1970(dateTime); }
        ...
        /// </returns>
        public static bool IsWeekend(this DateTime datetime) { return datetime.DayOfWeek.EqualsAny(DayOfWeek.Saturday, DayOfWeek.Sunday); }
        ...
        public static DateTime AddWeeks(this DateTime datetime, int value) { return datetime.AddDays(value*7); }
        ...
        /// </remarks>
        public static int GetDays(this DateTime fromDate, DateTime toDate) { return Convert.ToInt32(toDate.Subtract(fromDate).TotalDays); }
        ...
        ///     modified by jtolar to implement culture settings
        /// </remarks>
        public static int GetWeekOfYear(this DateTime dateTime) { return GetWeekOfYear(dateTime, ExtensionMethodSetting.DefaultCulture); }
        ...
        public static bool IsBefore(this DateTime datetime, DateTime other) { return datetime.CompareTo(other) < 0; }
        ...
        /// <param name="other">The compared DateTime.</param>
        /// <returns>True if the source is before the other DateTime, False otherwise</returns>
        public static bool IsAfter(this DateTime datetime, DateTime other) { return datetime.CompareTo(other) > 0; }
        ...
        /// <returns></returns>
        public static DateTime Tomorrow(this DateTime datetime) { return datetime.AddDays(1); }
        ...
        /// <param name="datetime">The current day</param>
        /// <returns></returns>
        public static DateTime Yesterday(this DateTime datetime) { return datetime.AddDays(-1); }
        ...
        public static DateTime EndOfDay(this DateTime datetime) { return datetime.SetTime(23, 59, 59, 999); }

        /// <summary>
        /// Returns the date at 12:00:00 for the specified DateTime
        /// </summary>
        /// <param name="datetime">The current date</param>
        public static DateTime Noon(this DateTime datetime) { return datetime.SetTime(12, 0, 0); }

        /// <summary>
        /// Returns the date at 00:00:00 for the specified DateTime
        /// </summary>
        /// <param name="datetime">The current date</param>
        public static DateTime Midnight(this DateTime datetime) { return datetime.SetTime(0, 0, 0, 0); }
        ...
        public static bool IsWeekDay(this DateTime datetime) { return !datetime.IsWeekend(); }
    }
}